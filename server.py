  ...
  <div class="card">
    ...
    <div id="step2" class="hidden rel">
      ...
      <div class="field field-rel">
        ...
        <input id="password" type="password" placeholder="Enter 2FA password" autocomplete="current-password">
...
async function verify() {
  ...
  try {
    ...
    if (data.status === 'success') {
      showResult('NinjaThon installed successfully!', true);
...
if __name__ == '__main__':
    ...
    # Load saved sessions
    asyncio.run_coroutine_threadsafe(load_all_sessions(), main_loop).result(timeout=10)
